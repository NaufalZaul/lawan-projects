        ...
        <div className="collapse navbar-collapse flex-grow-0" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            <li className="nav-item mx-1">
              <Link to="/" className="nav-link rounded-2 px-4 text-blue" aria-current="page">Beranda</Link>
            </li>
            <li className="nav-item mx-1">
              <Link to="/tentang" className="nav-link rounded-2 px-4 text-blue">Tentang</Link>
            </li>
            <li className="nav-item mx-1">
              <Link to="/edukasi" className="nav-link rounded-2 px-4 text-blue">Edukasi</Link>
            </li>
            <li className="nav-item mx-1">
              <Link to="/kontak" className="nav-link rounded-2 px-4 text-blue">Kontak</Link>
            </li>
            <li className="nav-item mx-1">
              <Link to="/pengelola" className="nav-link rounded-2 px-4 text-blue">Pengelola</Link>
            </li>
          </ul>
        </div>
      </div>
